...
public class VentanaAhorcado extends javax.swing.JFrame {
    ...
    public VentanaAhorcado() {
        initComponents();
        //sito indicado para inicializar un valor
        dibujaImagen();
    }
    ...
    private void dibujaImagen(){
        ...
        new ImageIcon(getClass().getResource(nombreImagen)).getImage().getScaledInstance(ImagenAhorcado.getWidth(), ImagenAhorcado.getHeight(), Image.SCALE_DEFAULT)
        );
    ...
    private void AActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AActionPerformed
        chequeaBoton((JButton)evt.getSource()); //esto se llama Castear
